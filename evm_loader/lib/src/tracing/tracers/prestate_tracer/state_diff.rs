...
use crate::tracing::tracers::{State, States};
...
pub fn build_prestate_tracer_state(pre: State) -> PrestateTracerPreState {
...
pub fn build_prestate_tracer_diff_mode_result(states: States) -> PrestateTracerDiffModeResult {
    let pre = build_prestate_tracer_state(states.pre);
